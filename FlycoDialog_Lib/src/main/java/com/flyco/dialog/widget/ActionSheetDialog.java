...
public class ActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
    ...
    private float mCornerRadius = 8;
    /** title background color(标题背景颜色) */
    private int mTitleBgColor = Color.parseColor("#ffffff");
    /** title text(标题) */
    ...
    public ActionSheetDialog(Context context, ArrayList<DialogMenuItem> baseItems, View animateView) {
        ...
        typeFace = Typeface.createFromAsset(context.getAssets(), "fonts/ElMessiri-Regular.ttf");
    ...
    public View onCreateView() {
        ...
        mTvCancel.setTypeface(typeFace);
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ivItem.setPadding(dp2px(16), 0, dp2px(16), 0);

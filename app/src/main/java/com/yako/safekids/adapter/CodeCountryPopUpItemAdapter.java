...
import com.yako.safekids.activity.ProfilUpdate;
import com.yako.safekids.activity.SignUp;
 ...
 */
public class CodeCountryPopUpItemAdapter extends RecyclerView.Adapter<CodeCountryPopUpItemAdapter.MyViewHolder> {
    ...
    public CodeCountryPopUpItemAdapter(Context context, AlertDialog alert, List<Country> mCountriesList, TextView code, RoundedImageView img){
        c = context;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (c instanceof ProfilUpdate) {
                ((ProfilUpdate) c).codeCountryTel = country.getCountryCode() + "";
            } else if (c instanceof SignUp) {
                ((SignUp) c).codeCountryTel = country.getCountryCode() + "";
            }

 ...
 */
public class KidsChooseItemAdapter extends RecyclerView.Adapter<KidsChooseItemAdapter.MyViewHolder> {
    ...
    public KidsChooseItemAdapter(Context context, List<Kids> listItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (langage.equals("ar")) {
            v = inflater.inflate(R.layout.rv_kids_choose_item, parent, false);
        } else {
            v = inflater.inflate(R.layout.rv_kids_choose_item_en, parent, false);
        }
        ...
        public MyViewHolder(View itemView) {
            ...
            check.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    if (b) {
                        ((MainActivity) context).alertKidsList.add(listItems.get(getPosition()));
                    } else {
                        ((MainActivity) context).alertKidsList.remove(listItems.get(getPosition()));
                    }
                }
            });

package com.yako.safekids.view.tabs;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, context.getResources().getInteger(R.integer.app_bar_text_size));

        Typeface typeFace = Typeface.createFromAsset(context.getAssets(), "fonts/jf_flat_medium.ttf");
        ...
        textView.setHeight((int) (41 * getResources().getDisplayMetrics().density));
